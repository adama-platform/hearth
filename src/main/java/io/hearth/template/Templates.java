...
public class Templates {
  ...
  public static final List<String> PAGES = List.of(
      "landing", "home", "notfound", "missing", "badhost", "minted", "message", "self", "connect",
      "board", "thread", "calendar", "event", "app", "sw", "places", "place_list", "place",
      "legal", "members", "member", "comments", "comment", "poll_option", "survey", "welcome", "tasks", "project", "task", "task_card", "ratings", "library", "definition", "ask", "signals", "api", "availability", "install",
      ...
      "admin/invites", "admin/invites_panel", "admin/invites_form",
      ...
      "admin/places", "admin/places_panel", "admin/places_form",
      "admin/placetypes", "admin/placetypes_panel", "admin/placetypes_form",
      "admin/proposals", "admin/proposals_panel",
      "admin/board", "admin/board_panel",
      "admin/flagged", "admin/flagged_panel",
      "admin/calendar", "admin/calendar_panel", "admin/calendar_form",
      "admin/suggestions", "admin/suggestions_panel",
      "admin/survey", "admin/survey_panel", "admin/survey_form",
      "admin/tasks", "admin/tasks_panel",
      "admin/retired", "admin/retired_panel",
