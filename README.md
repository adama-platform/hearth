...
All of it built, and covered by 1751 tests that boot the real server and talk to it over a socket.
...
**1751 tests**, and they are mostly not unit tests. The testkit boots the whole server on an
